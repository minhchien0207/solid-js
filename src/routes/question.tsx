    ...
    <>
      ...
      <div class="relative w-full">
        ...
        <div class="fab sticky right-5 bottom-5">
          <button
            class="btn flex items-center gap-2 rounded-[20px] bg-[#D8DEEE] font-bold text-[#474653]"
            onclick="faq_modal.showModal()"
          >
            ...
            <div class="flex flex-col gap-4 p-4 pt-3">
              {state.data.map((item, index) => (
                <details
                  ...
                  name="faq"
                >
                  <summary class="collapse-title text-[16px] leading-[22px] font-semibold lg:whitespace-nowrap">
                    {item.question}
                  </summary>
                  <div class="collapse-content text-regular text-[14px] leading-[25px]">
                    <ul role="list" class="list-disc marker:text-[#474653]">
